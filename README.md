...
| **TOKEN**<span id="env-token"></span> |                          | Generated from your [NordVPN account web portal](https://my.nordaccount.com/dashboard/nordvpn/). If you use Docker Compose for container startup, you can use [secrets](https://docs.docker.com/reference/compose-file/secrets/) feature to deliver NordVPN token. Just specify secret with `nordvpn_token_file` name and give access to that secret within nordvpn container                                                                                                                    |
