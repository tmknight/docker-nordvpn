...
| **TOKEN**<span id="env-token"></span> |                          | Generated from your [NordVPN account web portal](https://my.nordaccount.com/dashboard/nordvpn/). If you use Docker Compose for container startup, you can use the [secrets](https://docs.docker.com/reference/compose-file/secrets/) feature to deliver the NordVPN token. Just specify the secret with the name `nordvpn_token_file` and ensure the nordvpn container can access the file path                                                                                                                     |
