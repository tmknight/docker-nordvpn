...
| **CONNECTION_FILTERS**          |                          | In the format of "filters[filter0Name]&filters[filter1Name]..."; use [NordVPN API](https://github.com/tmknight/docker-nordvpn#additional-information) to help craft your filters (e.g `filters[country_id]=81`)                           |
